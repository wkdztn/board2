...
public class MyUtil {
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl) {
		...
		if(currentPage == 0 || totalPage ==0) return ""; // 0이면 데이터가 없다는 말. 빈값을 리턴한다.
		...
		// 1. ◀이전 버튼 만들기
		// currentPage가(1~4) (5~9) (10~14) (15~19) 5 10 15.. 일때 currentPageSetup 5 10 15..
		...
		while(page <= totalPage && page <= (currentPageSetup + numPerBlock)) {
			if(page == currentPage) {
				// 현재 내가 선택한 페이지라면 
				sb.append("<font color =\"green\">" + page + "</font>&nbsp;");
